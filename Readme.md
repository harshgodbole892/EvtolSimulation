...
The running of the tests require the PROJECT_HOME_DIR environemnt variable set to the project root folder. To run the executable, open a command prompt at the project root directory and run 
...
Note that the tests only cover the Vehicle class at the moment, they dont look at the other classes, however this is something that I intend to add given time in the future.
